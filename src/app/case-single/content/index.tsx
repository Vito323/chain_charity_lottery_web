                                                                ...
                                                                <div className="comment-wrapper">
                                                                    ...
                                                                    <div className="comment-area">
                                                                        ...
                                                                        <div className="comments-reply">
                                                                            <Link className="comment-reply-link" href="/casesingle"><i className="fa fa-reply" aria-hidden="true"></i><span>Reply</span></Link>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div className="comment-main-area">
                                                                        <div className="comment-wrapper">
                                                                            ...
                                                                            <div className="comment-area">
                                                                                <p>I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, </p>
                                                                                <div className="comments-reply">
                                                                                    <Link className="comment-reply-link" href="/casesingle"><span><i className="fa fa-reply" aria-hidden="true"></i> Reply</span></Link>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
