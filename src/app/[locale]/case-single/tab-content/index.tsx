...
const TabContent = () => {
  ...
  React.useEffect(() => {
    function updateHeight() {
      ...
      if (activeContent) {
        contentWrapperRef.current.style.height = activeContent.offsetHeight + "px";
      }
    }
    ...
    <section className="s-gallery page-gallery">
     <div className="tab-wrap">
          ...
          <div className="tabs-content" ref={contentWrapperRef}>
            <div className={`tab ${activeTab === 0 ? "visible-content" : ""}`}>
              <div className="row">
            ...
            <div className={`tab ${activeTab === 1 ? "visible-content" : ""}`}>
              <form action="#">
            ...
            <div className={`tab ${activeTab === 2 ? "visible-content" : ""}`}>
                        ...
                        <div id="div-comment-1">
                          <div className="comment-theme">
                            <div className="comment-image">
                              ...
                              <img
                                src={
                                  "/images/blog-details/comments-author/img-1.jpg"
                                }
                                alt=""
                              />{" "}
                            </div>
                            ...
                            <div>
                              <div className="comment-theme">
                                <div className="comment-image">
                                  ...
                                  <img
                                    src={
                                      "/images/blog-details/comments-author/img-2.jpg"
                                    }
                                    alt=""
                                  />
                                </div>
                                ...
                                <div>
                                  <div className="comment-theme">
                                    <div className="comment-image">
                                      <img
                                        src={
                                          "/images/blog-details/comments-author/img-3.jpg"
                                        }
                                        alt=""
                                      />{" "}
                                    </div>
