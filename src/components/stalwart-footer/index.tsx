        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          >
            ...
            <p className="text-gray-300 mb-8">
              Get the latest updates on AI innovations, product releases, and industry insights delivered to your inbox.
            </p>
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 bg-white/10 border border-white/20 rounded-full text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                required
              />
              <motion.button
                type="submit"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <span className="text-2xl font-bold">Stalwart AI</span>
              </div>
              <p className="text-gray-300 mb-6 leading-relaxed">
                Revolutionizing the future with cutting-edge artificial intelligence solutions that transform industries and empower human potential.
              </p>
        ...
        >
          <p className="text-gray-300 text-sm mb-4 md:mb-0">
            © 2024 Stalwart AI. All rights reserved.
          </p>
