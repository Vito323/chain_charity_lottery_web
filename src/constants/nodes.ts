...
export const NODES_DATA: NodeData[] = [
  {
    ...
    investmentReturns: {
      ...
      returnDescription:
        "Genesis nodes offer the highest returns with a projected 2408% total return over 3 years.",
    },
    ...
    priceAdvantage: {
      ...
      advantageDescription:
        "Genesis node holders enjoy a 14.6x price advantage compared to public offering.",
    },
  ...
  },
  {
    ...
    investmentReturns: {
      ...
      returnDescription:
        "Super nodes provide excellent returns with a projected 1200% total return over 3 years.",
    },
    ...
    priceAdvantage: {
      ...
      advantage: "14.6x",
      advantageDescription:
        "Super node holders enjoy a 14.6x price advantage compared to public offering.",
    },
  ...
  },
  {
    ...
    investmentReturns: {
      ...
      totalReturnRate: "100%",
      returnDescription:
        "Standard nodes offer stable returns with a projected 100% total return over 3 years.",
    },
    ...
    priceAdvantage: {
      ...
      advantage: "14.6x",
      advantageDescription:
        "Standard node holders enjoy a 14.6x price advantage compared to public offering.",
    },
...
export const getNodeById = (nodeId: string): NodeData | undefined => {
  ...
  return NODES_DATA.find((node) => node.id === nodeIdLower);
};
